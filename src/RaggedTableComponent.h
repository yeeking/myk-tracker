...
public:
    ...
    void draw(std::vector<std::vector<std::string>>& data, size_t rowsToDisplay, size_t colsToDisplay, size_t cursorX, size_t cursorY, std::vector<std::pair<int, int>> highlightCells);
